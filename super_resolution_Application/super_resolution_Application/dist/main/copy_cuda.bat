...
set cudapath=.\cuda10
copy %cudapath%\cublas64_100.dll %python_venv% /v /y
copy %cudapath%\cudart32_100.dll %python_venv% /v /y
copy %cudapath%\cudart64_100.dll %python_venv% /v /y
copy %cudapath%\cudnn64_7.dll %python_venv% /v /y
copy %cudapath%\cufft64_100.dll %python_venv% /v /y
copy %cudapath%\cufftw64_100.dll %python_venv% /v /y
copy %cudapath%\cuinj64_100.dll %python_venv% /v /y
copy %cudapath%\curand64_100.dll %python_venv% /v /y
copy %cudapath%\cusolver64_100.dll %python_venv% /v /y
copy %cudapath%\cusparse64_100.dll %python_venv% /v /y
